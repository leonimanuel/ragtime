...
// ok, so I have my list of questions and array of possible answers for each. 
// I need the chat to ask these one by one, only preceeding to the next question after it's sure the user has answered the current one.